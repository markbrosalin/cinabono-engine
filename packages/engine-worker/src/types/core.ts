...
export type RpcRequest = { id: RpcPendingId; path: string; payload: unknown };

type TruthyResponce<R = any> = { ok: true; request: RpcRequest; result: R };
type FalsyResponce = { ok: false; request: RpcRequest; error: unknown };
