...
export type ScheduleInputParams = Pick<
    ScheduleBase,
    "itemId" | "pin" | "value" | "t" | "gen" | "srcItemId" | "srcOutPin"
> & { kind: "input" };
...
export type SimInputEvent = Extract<SimEvent, { kind: "input" }>;
export type SimOutputEvent = Extract<SimEvent, { kind: "output" }>;
