...
export type KindsWithoutRole<R extends RoleOf<KindKey>> = Exclude<
    KindKey,
    {
...
export type KindsWithRole<R extends RoleOf<KindKey>> = Extract<
    KindKey,
    {
        [K in KindKey]: RoleOf<K> extends R ? K : never;
    }[KindKey]
...
export type PinDelay = { rise: number; fall: number };
...
export type CircuitPinRef = { circuitId: Id; circuitPin: PinIndex };
