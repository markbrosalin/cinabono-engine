...
export type WithInnerItemOutputLinks = {
    outputLinks?: InnerItemOutputLinks;
};
export type WithInnerItemInputLinks = {
    inputLinks?: InnerItemInputLinks;
};
export type WithInnerItemInOutLinks = WithInnerItemOutputLinks & WithInnerItemInputLinks;
export type WithInnerItemLinks<K extends KindKey> = WithOf<K, InnerItemLinksMap>;
...
//# sourceMappingURL=inner-links.d.ts.map