...
import { KindKey, Pin, WithHash, WithInputItems, WithInputPins, WithOutputItem, WithOutputPins } from "../shared/item";
...
export declare const isLogicItem: (i: unknown) => i is import("./types").LogicItem;
export declare const isGeneratorItem: (i: unknown) => i is import("./types").GeneratorItem;
export declare const isDisplayItem: (i: unknown) => i is import("./types").DisplayItem;
export declare const isCircuitItem: (i: unknown) => i is import("./types").CircuitItem;
