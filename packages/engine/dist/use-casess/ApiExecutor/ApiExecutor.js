...
//             bus.emit("api.useCase.start", { ...ctx.meta, payload });
//             try {
//                 const result = dispatch(0, ...payload);
//                 bus.emit("api.useCase.finish", { ...ctx.meta, result });
//                 return result;
//             } catch (error) {
//                 bus.emit("api.useCase.error", { ...ctx.meta, error });
//                 throw error;
//             }
...
//                     bus.emit("api.useCaseFn.start", { ...ctx.meta, payload: args });
//                     const out = core(...args);
//                     bus.emit("api.useCaseFn.finish", { ...ctx.meta, result: out });
//                     return out;
//                 }
//                 // middleware
